			...
			<div class="row">
				...
				<div class="ibox">
					<div class="ibox content">
						...
						<?php
						$getBlogs =  mysql_query("SELECT users.domain, users.email, blogs.pt, blogs.cost, status, info FROM blogs,users where user_id=id and user_id =1") or die(mysql_error());
