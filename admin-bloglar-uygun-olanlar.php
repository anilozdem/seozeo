...
<body>
			...
			<a href="admin-bloglar-uygun-olanlar.php" onclick="fnClickAddRow();" href="javascript:void(0);" class="btn btn-success ">Uygun Olanlar</a>
							...
							if(isset($filtrele))
										...
										if ($blogAdi=="bos" and $durum=="blogtitle" and $ilkTarih=="" and $sonTarih==""){
										 ...
										 //blog adına göre
												...
												$getBlogs =  mysql_query("SELECT blog_id,name,email,pt,cost,info,domain FROM blogs where info='Uygun' and domain='$blogAdi'") or die(mysql_error());
										...
										//durumuna göre
												...
												$getBlogs =  mysql_query("SELECT blog_id,name,email,pt,cost,info,domain FROM blogs where info='Uygun' and  info='$durum'") or die(mysql_error());
										...
										//blog adı ve durumuna göre
												...
												$getBlogs =  mysql_query("SELECT blog_id,name,email,pt,cost,info,domain FROM blogs where info='Uygun' and  domain='$blogAdi' and info='$durum'") or die(mysql_error());
										...
										//sadece tarih 
												...
												$getBlogs =  mysql_query("SELECT blog_id,name,email,pt,cost,info,domain FROM blogs where info='Uygun' and  reg_date between '$ilkTarih' and '$sonTarih'") or die(mysql_error());
										...
										//hepsi seçiliyken
												...
												$getBlogs =  mysql_query("SELECT blog_id,name,email,pt,cost,info,domain FROM blogs where info='Uygun' and domain='$blogAdi' and info='$durum' and reg_date between '$ilkTarih' and '$sonTarih'") or die(mysql_error());
								...
								$getBlogs =  mysql_query("SELECT blog_id,name,email,pt,cost,info,domain FROM blogs where info='Uygun'") or die(mysql_error());
