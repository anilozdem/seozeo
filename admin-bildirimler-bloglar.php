...
<body>
			...
			<a href="admin-bildirimler-bloglar.php" onclick="fnClickAddRow();" class="btn btn-success ">Bloglar</a>
			...
			<?php
						...
						$getBlogs =  mysql_query("SELECT * FROM notifications where type='Blog' and checked='0'") or die(mysql_error());
						$count =  mysql_query("SELECT COUNT(*) FROM notifications where type='Blog' and checked='0'") or die(mysql_error());
						...
						$getOld =  mysql_query("SELECT * FROM notifications where type='Blog' and checked='1'") or die(mysql_error());
