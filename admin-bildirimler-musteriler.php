...
<body>
			...
			<a href="admin-bildirimler-musteriler.php" onclick="fnClickAddRow();" class="btn btn-success ">Müşteriler</a>
			...
			<?php
						...
						$getBlogs =  mysql_query("SELECT * FROM notifications where type='Müşteri' and checked='0'") or die(mysql_error());
						$count =  mysql_query("SELECT COUNT(*) FROM notifications where type='Müşteri' and checked='0'") or die(mysql_error());
						...
						$getOld =  mysql_query("SELECT * FROM notifications where type='Müşteri' and checked='1'") or die(mysql_error());
